...
output_dir = "musique_hotpot_wiki2_nq_tqa_sqd"
...
output_path = os.path.join("classifier", "data", output_dir)

save_json(os.path.join(output_path, 'predict.json'), lst_total_data)

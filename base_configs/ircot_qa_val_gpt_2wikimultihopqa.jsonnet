# OPTIMIZED HYPERPARAMETERS FOR GPT
# Reason: GPT settings are already optimized from previous experiments
# Updated: max_tokens_per_step will be increased in labeler implementation
# Changes: bm25_retrieval_count: 6 → 6, model_length_limit → 8000, estimated_generation_length: 300 → 300, global_max_num_paras: 15 → 15, distractor_count: 2 → 2

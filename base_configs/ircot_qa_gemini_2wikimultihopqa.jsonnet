# OPTIMIZED HYPERPARAMETERS FOR GEMINI
# Reason: Gemini has large context window and can handle more complex reasoning
# Updated: max_tokens_per_step will be increased in labeler implementation
# Changes: bm25_retrieval_count: 6 → 8, model_length_limit → 128000, estimated_generation_length: 300 → 400, global_max_num_paras: 15 → 20, distractor_count: 2 → 3
...
local valid_qids = {
    "temp" : ["5ab92dba554299131ca422a2","5a7bbc50554299042af8f7d0","5add363c5542990dbb2f7dc8","5a835abe5542996488c2e426","5ae0185b55429942ec259c1b","5a790e7855429970f5fffe3d","5a754ab35542993748c89819","5a89c14f5542993b751ca98a","5abb14bd5542992ccd8e7f07","5a89d58755429946c8d6e9d9","5a88f9d55542995153361218","5a90620755429933b8a20508","5a77acab5542992a6e59df76","5abfb3435542990832d3a1c1","5a8f44ab5542992414482a25","5adfad0c554299603e41835a","5a7fc53555429969796c1b55","5a8ed9f355429917b4a5bddd","5ac2ada5554299657fa2900d","5a758ea55542992db9473680"],
    "hotpotqa": ["5ab92dba554299131ca422a2","5a7bbc50554299042af8f7d0","5add363c5542990dbb2f7dc8","5a835abe5542996488c2e426","5ae0185b55429942ec259c1b","5a790e7855429970f5fffe3d","5a754ab35542993748c89819","5a89c14f5542993b751ca98a","5abb14bd5542992ccd8e7f07","5a89d58755429946c8d6e9d9","5a88f9d55542995153361218","5a90620755429933b8a20508","5a77acab5542992a6e59df76","5abfb3435542990832d3a1c1","5a8f44ab5542992414482a25","5adfad0c554299603e41835a","5a7fc53555429969796c1b55","5a8ed9f355429917b4a5bddd","5ac2ada5554299657fa2900d","5a758ea55542992db9473680"],
    "2wikimultihopqa" : ["028eaef60bdb11eba7f7acde48001122","13cda43c09b311ebbdb0ac1f6bf848b6","1ceeab380baf11ebab90acde48001122","228546780bdd11eba7f7acde48001122","35bf3490096d11ebbdafac1f6bf848b6","4724c54e08e011ebbda1ac1f6bf848b6","5811079c0bdc11eba7f7acde48001122","5897ec7a086c11ebbd61ac1f6bf848b6","79a863dc0bdc11eba7f7acde48001122","8727d1280bdc11eba7f7acde48001122","97954d9408b011ebbd84ac1f6bf848b6","a5995da508ab11ebbd82ac1f6bf848b6","af8c6722088b11ebbd6fac1f6bf848b6","c6805b2908a911ebbd80ac1f6bf848b6","c6f63bfb089e11ebbd78ac1f6bf848b6","cdbb82ec0baf11ebab90acde48001122","e5150a5a0bda11eba7f7acde48001122","f1ccdfee094011ebbdaeac1f6bf848b6","f44939100bda11eba7f7acde48001122","f86b4a28091711ebbdaeac1f6bf848b6"],
...
local prompt_reader_args = {
    ...
    "order_by_key": "qid",
    "estimated_generation_length": 400,
    "shuffle": false,
    "model_length_limit": 128000,
};
...

{
    ...
    "models": {
        ...
        "step_by_step_cot_reasoning_gen": {
            ...
            "prompt_file": "prompts/"+dataset+"/"+rc_context_type+"_context_cot_qa_gemini.txt",
        ...
        "answer_main_question": {
            ...
            "prompt_file": "prompts/"+dataset+"/"+rc_context_type+"_context_"+rc_qa_type+"_qa_gemini.txt",
            "prompt_reader_args": prompt_reader_args,
            "end_state": "[EOQ]",
            "gen_model": "gemini",
            "engine": "gemini-2.5-flash-lite",

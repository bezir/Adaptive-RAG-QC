...
class LLMQAModel:
    def __init__(
        self, prompt_file="", prompt_reader_args=None, regex_extract=None, add_context=True, gen_model="gemini", **kwargs
    ):
        if prompt_file:
        ...
        # Initialize the appropriate generator based on gen_model

...
# from commaqa.inference.decomposer import QuestionDecomposerParticipant  # Commented out - module missing

MODEL_NAME_CLASS = {
    "answer_extractor": AnswerExtractor,
    "copy_question": CopyQuestionParticipant,
    "llmqa": LLMQAParticipantModel,
    # "question_decomposer": QuestionDecomposerParticipant,  # Commented out - module missing

#!/usr/bin/env python3
"""
Processing Scripts Utility Library

This library provides utility functions specific to data processing scripts,
including server configuration, dataset inference, file operations, and
text matching utilities.

The library is similar to the main lib.py but tailored for data processing
tasks and may have different configurations or simplified implementations.
"""
...
def infer_dataset_from_file_path(file_path: str) -> str:
    ...
    Note: This is a simplified version for processing scripts, supporting
    only the core multi-hop datasets.
    ...
    # Core multi-hop datasets supported by processing scripts
...
def read_json(file_path: str) -> Dict:
    """
    Read and parse a JSON file with proper encoding handling.
